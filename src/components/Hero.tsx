    ...
    >
      ...
      <div className="relative z-10 container-xl px-4 sm:px-8 lg:px-16 xl:px-24 py-12 sm:py-16 w-full mt-[100px] sm:mt-[150px] md:mt-[180px] lg:mt-[200px]">
        <div className="max-w-3xl mx-auto sm:mx-0 text-center sm:text-left">
          ...
          {/* Sub-headline */}
          <p className="font-body text-white/90 text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed mb-4 sm:mb-5 animate-fade-in-up stagger-3 drop-shadow-md max-w-full sm:max-w-xl mx-auto sm:mx-0">
          ...
          {/* Key Features */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-2.5 mb-4 sm:mb-5 animate-fade-in-up stagger-3">
            <div className="flex items-center justify-center sm:justify-start gap-2 text-white/90 text-[11px] sm:text-sm">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 animate-fade-in-up stagger-4">
            ...
            <Link
              ...
              className="bg-white/10 backdrop-blur-sm border-2 border-white/50 hover:border-white hover:bg-white/20 text-white font-display font-bold px-6 sm:px-8 py-3 sm:py-3.5 rounded-sm transition-all duration-200 flex items-center justify-center gap-2 hover:-translate-y-0.5 text-sm sm:text-base"
            >
              View Products
            </Link>
          </div>
          ...
          <div className="flex items-center justify-center sm:justify-start gap-4 sm:gap-6 mt-4 sm:mt-5 pt-4 sm:pt-5 border-t border-white/10 animate-fade-in-up stagger-4">
            <div className="flex items-center gap-1.5 sm:gap-2">
              ...
              />
              <span className="text-white/70 text-[10px] sm:text-xs font-body">
                10+ Years Excellence
              </span>
            </div>
            <div className="flex items-center gap-1.5 sm:gap-2">

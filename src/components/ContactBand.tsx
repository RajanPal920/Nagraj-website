        ...
        <div className="grid lg:grid-cols-2 gap-14 items-start">
          ...
          <div>
            ...
            <div className="space-y-5">
              ...
              >
                <div className="w-11 h-11 rounded-sm bg-white/20 border border-white/30 flex items-center justify-center group-hover:bg-white transition-colors duration-300">
                  <Phone
                    size={18}
              ...
              >
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-white/10 border border-white/20 text-white placeholder:text-white/70 rounded-sm px-4 py-3 text-sm font-body focus:outline-none focus:border-white focus:bg-white/20 transition-all duration-200"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-white/10 border border-white/20 text-white placeholder:text-white/70 rounded-sm px-4 py-3 text-sm font-body focus:outline-none focus:border-white focus:bg-white/20 transition-all duration-200 resize-none"
                  />
                </div>
